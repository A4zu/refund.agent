...
# Gmail məlumatları (App Password ilə)
os.environ["GMAIL_ADDRESS"] = "sizin-gonderen-hesabiniz@gmail.com"
os.environ["GMAIL_APP_PASSWORD"] = "abcdefghijklmnop"  # boşluqsuz
...
def human_review(state: CustomerRefundState):
    ...
    receiver_email = "arzuismayilzade283@gmail.com"
